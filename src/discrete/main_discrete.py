...
if __name__ == '__main__':
    ...
    parser.add_argument('--env_name', type=str, default="sumo-rl-v0")   # name of the environment
    parser.add_argument('--offline_size', type=int, default=int(1e5))   # size of offline data
    ...
    parser.add_argument('--epochs_trn', type=int, default=150)  # number of epochs in training
    parser.add_argument('--epochs_eva', type=int, default=50)   # number of epochs in evaluation
    ...
    parser.add_argument('--max_ep_len', type=int, default=100)  # maximum length of one episode in sampling
