...
def eva_fixed(ac_old, ac_new, o_initial, cost_fn, act_gen_runs, primary=False):
...
def nac_decision(ac_old, ac_new, o_initial, cost_fn, act_gen_runs=10000,
    ...
    eva_old = eva_fixed(ac_old, ac_old, o_initial, cost_fn, act_gen_runs, primary = True)
    eva_new = eva_fixed(ac_old, ac_new, o_initial, cost_fn, act_gen_runs, primary = False)
