...
def sac(env_name, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
    ...
    def compute_loss_q(data):
        ...
        with torch.no_grad():
            ...
            a2, logp_a2, _ = ac.pi(o2, with_logprob=True)
    ...
    def compute_loss_pi(data):
        o = data['obs']
        pi, logp_pi, _ = ac.pi(o, with_logprob=True)
        q1_pi = ac.q1(o, pi)
        q2_pi = ac.q2(o, pi)
    ...
    def test_agent():
        for j in range(num_test_episodes):
            ...
            while not(trm or trc or (ep_len == max_ep_len)):
                ...
                o, r, trm, trc, _ = test_env.step(get_action(o, True))
                ep_ret += r
                ep_len += 1
    ...
    for t in range(total_steps):
        ...
        trm = False if ep_len==max_ep_len else trm
