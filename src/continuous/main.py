...
if __name__ == '__main__':
    ...
    parser.add_argument('--offline_size', type=int, default=int(1e6))
    parser.add_argument('--batch_size', type=int, default=256)
    parser.add_argument('--scratch', type=bool, default=False)
    parser.add_argument('--act_partition', type=str, default="default")
    parser.add_argument('--lc', type=int, default=5) # 50
    parser.add_argument('--tc', type=int, default=0.1) #1
    ...
    parser.add_argument('--epochs_trn', type=int, default=1000)
    parser.add_argument('--epochs_eva', type=int, default=100)
    parser.add_argument('--gamma', type=float, default=0.99)
    parser.add_argument('--lr', type=float, default=0.0003)
    parser.add_argument('--act_gen_runs_trn', type=int, default=1000)
    parser.add_argument('--act_gen_runs_eva', type=int, default=10000)
